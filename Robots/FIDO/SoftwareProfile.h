...
#define BEHAVIOR_SCRIPT_PATH "/root/lua/behaviors"	//Behavior Tree
#define HOOK_SCRIPT_PATH "/root/lua/hooks"			//Event hooks
#define MAIN_SCRIPT_PATH "/root/lua/scripts"		//Available scripts
